...
class TestSiteCheckConsumerParsePHP:
    ...
    @pytest.mark.parametrize(
        "green, hosting_provider_id, green_domain_count, greencheck_ip_range_id, greencheck_match_type",  # noqa
        (
            (True, 595, 1, 198, "as"),
            (True, 595, 1, 0, "url"),
            (False, None, 0, 0, "none"),

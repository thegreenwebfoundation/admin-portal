...
# These are used for running our imports of Azure IP ranges
...
# These are used for running our imports from AWS
AWS_PROVIDER_ID = env("AWS_PROVIDER_ID")
AWS_DATASET_ENDPOINT = env("AWS_DATASET_ENDPOINT")
